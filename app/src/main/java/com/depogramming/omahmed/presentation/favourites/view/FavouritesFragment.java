...
public class FavouritesFragment extends Fragment implements FavouritesView, OnHeartClicked {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        favouritesPresenter= new FavouritesPresenterImp(getActivity().getApplicationContext(),this,this);
